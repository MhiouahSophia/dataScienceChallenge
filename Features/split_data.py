...
def split_train_test(feedback_clean,theme_code_clean):
    ...
    feedback_train, feedback_test, theme_train_code, theme_test_code = train_test_split(feedback_clean, theme_code_clean, test_size=0.20, shuffle=True, random_state=877839)
